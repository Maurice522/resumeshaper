  ...
  const submitLoginHandler = async (e) => {
    ...
    if (jobTitle !== "" && jobDescription !== "") {
      try {
        ...
        await getAiSkills();
        logActivity(
          activity.tailorResumeToJob.type,
          user?.resumes[idx]?.id,
          generateRandomId(),
          activity.tailorResumeToJob.description,
          user?.email
        );
        ...
        console.log(error);
        alert(
          "An error occured while processing your document. Please try again later"
        );
      } finally {
        setIsLoading(false);
      }
    ...
    <div className="popup">
      <div className="popup-content">
        ...
        {isLoading ? (
          ...
          <div>
            <p className="jobInstructionPopup">
              Document successfully processed!{" "}
            </p>
            <p className="jobInstructionLowerPopup">
              Your professional summary and skills have been optimized to match
              the provided job title and description. Feel free to edit them,
              along with other fields, to suit your preferences.
            </p>
            <button onClick={handleConfirmClose} className="loginNow">
              Understood
            </button>
          </div>
        ) : (
          <form className="loginForm" onSubmit={submitLoginHandler}>
            ...
            <div className="form-group">
              ...
              <p className="jobPopupDescriptionP">
                Include or replicate the job description as mentioned on the
                employer's website within the specified field.
              </p>
              <textarea
