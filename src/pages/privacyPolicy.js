    ...
    <div>
      ...
      <div className="aboutUsContainer">
        ...
        <p className='aboutUsContent'>
          ...
          <p>SaaSmartSolutions ("we," "our," or "us") is dedicated to safeguarding your privacy and ensuring the security of your personal information. This Privacy Policy outlines our practices regarding the collection, use, disclosure, and protection of your data when you engage with our website, products, or services.</p>
          ...
          <ul itemType='disc'>
            <li>Directly from you when you create an account, make a purchase, or interact with our services.</li>
            <li>Automatically through cookies and similar technologies as you navigate our website.</li>
            <li>From third-party sources for authentication and fraud prevention purposes.</li>
          </ul>

          <h6>Use of Information</h6>
          <p>We use your information for the following purposes:</p>
          <ul itemType='disc'>
            <li>To provide, enhance, and personalize our products and services.</li>
          ...
          <ul itemType='disc'>
            <li>Service providers and partners involved in delivering our products and services.</li>
          ...
          <h6>Security</h6>
          <p>YWe implement reasonable security measures to protect your information. However, no method of transmission over the internet or electronic storage is entirely secure.</p>
          ...
          <h6>Contact Us</h6>
          <p>If you have questions or concerns about this Privacy Policy, please contact us at [privacy@saasmartsolutions.com].
