        ...
        <div>
            ...
            <div className='section3'>
                ...
                <div id="carouselExampleRide" class="carousel slide" data-bs-ride="true">
                    ...
                    <button class="carousel-control-prev landing-carousel-control-prev" type="button" data-bs-target="#carouselExampleRide" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next landing-carousel-control-next" type="button" data-bs-target="#carouselExampleRide" data-bs-slide="next">
